                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-cta-container">
                                ...
                                <button class="btn btn-warning editNoticiasModalButton" id="${id}" data-toggle="modal" data-target="#editNoticiasModal">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" id="${id}" viewBox="0 0 16 16">
